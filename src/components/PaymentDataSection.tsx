    ...
    <section className="mb-6">
      <div className="bg-white rounded-xl border border-slate-200 p-4 sm:p-6">
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-[#11143F]/10 rounded-lg flex items-center justify-center flex-shrink-0">
              <DollarSign className="text-[#11143F] w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-slate-900">Datos de Pago</h3>
              <p className="text-xs sm:text-sm text-slate-500">Información salarial base</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-2 sm:mb-3">Tipo de salario</label>
            <div className="flex space-x-2 sm:space-x-3">
              <button
                onClick={() => onChange({ salaryType: 'monthly' })}
                className={cn(
                  'flex-1 px-3 sm:px-4 py-2.5 sm:py-3 border-2 rounded-lg font-medium transition-all flex items-center justify-center text-sm sm:text-base',
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-2 sm:mb-3">Valor del salario</label>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-2 sm:mb-3">Días trabajados por semana</label>
            <div className="relative">
              <select
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-2 sm:mb-3">Visualización de resultados</label>
